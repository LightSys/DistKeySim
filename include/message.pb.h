...
inline bool InformationalMessageContents_CollectionInformationRecord::_internal_has_creationratedata() const {
  return this != internal_default_instance() && _impl_.creationratedata_ != nullptr;
}
...
inline ::KeyspaceMessageContents_Keyspace* KeyspaceMessageContents::mutable_keyspaces(int index) {
  ...
  return _impl_.keyspaces_.Mutable(index);
}
...
inline const ::KeyspaceMessageContents_Keyspace& KeyspaceMessageContents::_internal_keyspaces(int index) const {
  return _impl_.keyspaces_.Get(index);
}
...
void Message::set_sourcenodeid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sourcenodeid_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Message::set_allocated_sourcenodeid(std::string* sourcenodeid) {
  ...
  _impl_.sourcenodeid_.SetAllocated(sourcenodeid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void Message::set_destnodeid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.destnodeid_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Message::set_allocated_destnodeid(std::string* destnodeid) {
  ...
  _impl_.destnodeid_.SetAllocated(destnodeid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
