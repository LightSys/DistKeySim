...
if __name__ == '__main__':
    ...
    parser.add_argument('--num', '-n', type=int, help='Scenario number')
    ...
    print("Testing Scenario %d with %s iterations (%g days) ..." % (num, iterations, days))

    numKeyspaces = runOneSim(configFileName, "full", iterations, num)
    exec(args.assertion)
